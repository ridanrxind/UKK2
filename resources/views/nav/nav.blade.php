...
<style>
  ...
  <body class="bg-black text-white mt-0" data-bs-spy="scroll" data-bs-target="#navScroll">
    ...
    <span class="ms-md-1 mt-1 fw-bolder me-md-5">{{$school}}</span>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 list-group list-group-horizontal">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link fs-5" href="/content" aria-label="A sample content page">
                    Content
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link fs-5" href="/system" aria-label="A system message page">
                    System
                </a>
            </li>
        </ul>
